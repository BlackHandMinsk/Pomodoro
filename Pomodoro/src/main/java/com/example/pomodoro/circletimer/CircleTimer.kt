package com.example.pomodoro.circletimer
...
class CircleTimer @JvmOverloads constructor(
    ...
    init {
        if (attrs != null) {
            ...
            color = styledAttrs.getColor(R.styleable.CircleTimer_custom_color, Color.RED)
            style = styledAttrs.getInt(R.styleable.CircleTimer_custom_style, FILL)
            styledAttrs.recycle()
        }
